    ...
    <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-6">
              ...
              <p className="text-gray-300 text-sm">
                Land clearing is one tool we use to transform your land. Most projects combine
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4">Investment Range</h2>
          <p className="text-gray-400 text-center mb-12">
            Complete site prep - cleared to dirt, ready for construction
          </p>

          <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-6 mb-8 max-w-4xl mx-auto">
            <h3 className="text-xl font-semibold text-center mb-6 text-green-400">Typical Project Costs</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-sm text-gray-400 mb-2">Quarter Acre</div>
                <div className="text-3xl font-bold text-white mb-1">$10,900</div>
                <div className="text-xs text-gray-500">Includes clearing + hauling</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-400 mb-2">Half Acre</div>
                <div className="text-3xl font-bold text-white mb-1">$16,800</div>
                <div className="text-xs text-gray-500">Includes clearing + hauling</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-400 mb-2">One Acre</div>
                <div className="text-3xl font-bold text-white mb-1">$29,000</div>
                <div className="text-xs text-gray-500">Includes clearing + hauling</div>
              </div>
            </div>
            <div className="mt-6 pt-6 border-t border-green-500/30">
              <p className="text-center text-gray-400 text-sm">
                <span className="font-semibold text-green-400">What's included:</span> All trees/stumps/roots removed, debris hauled away, rough grade ready for construction
              </p>
              <p className="text-center text-gray-400 text-sm mt-2">
                Plus equipment transport. Final price confirmed after site visit. $5,000 project minimum.
              </p>
            </div>
          </div>
        </div>
